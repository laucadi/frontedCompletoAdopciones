...
export class EditarUsuarioComponent implements OnInit {
  ...
  obtener() {
    this.route.params.subscribe((params) => {
      ...
      this.usuarioService.obtenerUsuario(this.id).subscribe((response) => {
        this.usuario = response;
        console.log(this.usuario);
        this.formValue.controls['nombres'].setValue(this.usuario.nombres);
        this.formValue.controls['primerApellido'].setValue(
          this.usuario.primerApellido
        );
        this.formValue.controls['segundoApellido'].setValue(
  ...
  actualizarMascota() {
    ...
    this.usuarioService
      .actualizarUsuario(this.usuarioModel, this.usuarioModel._id)
      .subscribe((res) => {
        Swal.fire('Usuario actualizado!', 'You clicked the button!', 'success');
        setTimeout(() => {
